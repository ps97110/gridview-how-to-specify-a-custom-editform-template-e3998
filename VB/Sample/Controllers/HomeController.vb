...
Namespace Sample.Controllers
	...
	Public Class UploadControlHelper
        Public Shared ReadOnly ValidationSettings As New UploadControlValidationSettings() With {.AllowedFileExtensions = New String() {".jpg", ".jpeg", ".jpe"}, .MaxFileSize = 4000000}
